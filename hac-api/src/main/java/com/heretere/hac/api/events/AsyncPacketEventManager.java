...
public class AsyncPacketEventManager {
     ...
     */
    public void callPacketEvent(@NotNull final HACPlayer player,
     ...
     */
    public void callPacketEvent(@NotNull final HACPlayer player, @NotNull final WrappedPacket packet) {
