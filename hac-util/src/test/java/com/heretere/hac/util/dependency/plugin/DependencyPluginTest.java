...
public final class DependencyPluginTest extends DependencyPlugin {
    public DependencyPluginTest() {
        super("HAC");
    }

    DependencyPluginTest(JavaPluginLoader loader, PluginDescriptionFile description, File dataFolder, File file) {
